defmodule FoodTrucksWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FoodTrucksWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FoodTrucksWeb.Gettext, "errors", msg, opts)
    end
  end
