defmodule FoodTrucks.FoodTest do
  ...
  describe "facilities" do
    ...
    @invalid_attrs %{address: nil, applicant: nil, approved: nil, block: nil, blocklot: nil, cnn: nil, days_hours: nil, expiration_date: nil, facility_type: nil, food_items: nil, latitude: nil, location_description: nil, location_id: nil, longitude: nil, lot: nil, noi_sent: nil, permit: nil, prior_permit: nil, received: nil, schedule: nil, status: nil, x: nil, y: nil}
    ...
    test "create_facility/1 with valid data creates a facility" do
      valid_attrs = %{address: "some address", applicant: "some applicant", approved: ~N[2023-03-29 07:31:00], block: "some block", blocklot: "some blocklot", cnn: 42, days_hours: "some days_hours", expiration_date: ~N[2023-03-29 07:31:00], facility_type: "some facility_type", food_items: "some food_items", latitude: 120.5, location_description: "some location_description", location_id: 42, longitude: 120.5, lot: "some lot", noi_sent: ~N[2023-03-29 07:31:00], permit: "some permit", prior_permit: true, received: ~N[2023-03-29 07:31:00], schedule: "some schedule", status: "some status", x: 120.5, y: 120.5}
    ...
    test "update_facility/2 with valid data updates the facility" do
      facility = facility_fixture()
      update_attrs = %{address: "some updated address", applicant: "some updated applicant", approved: ~N[2023-03-30 07:31:00], block: "some updated block", blocklot: "some updated blocklot", cnn: 43, days_hours: "some updated days_hours", expiration_date: ~N[2023-03-30 07:31:00], facility_type: "some updated facility_type", food_items: "some updated food_items", latitude: 456.7, location_description: "some updated location_description", location_id: 43, longitude: 456.7, lot: "some updated lot", noi_sent: ~N[2023-03-30 07:31:00], permit: "some updated permit", prior_permit: false, received: ~N[2023-03-30 07:31:00], schedule: "some updated schedule", status: "some updated status", x: 456.7, y: 456.7}
